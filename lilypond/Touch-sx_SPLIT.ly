...
Solo =  \relative bes {
    ...
    \stemUp b4 -. \stemUp b4 -. \stemUp g'4 \stemUp f4 | \barNumberCheck #70
...
\book {
  \bookOutputSuffix "0Riff"
  \score { \Riff }
  \layout { }
}

\book {
  \bookOutputSuffix "1Refrain"
  \score { \Refrain }
  \layout { }
}

\book {
  \bookOutputSuffix "2Bridge"
  \score { \Bridge }
  \layout { }
}

\book {
  \bookOutputSuffix "3Solo"
  \score { \Solo }
  \layout { }
}

\book {
  \bookOutputSuffix "4Refrain_Sax"
  \score { \Refrain_Sax }
  \layout { }
}

\book {
  \bookOutputSuffix "5Interlude"
  \score { \Interlude }
  \layout { }
}